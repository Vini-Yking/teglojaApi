...
insert into tegloja.categoria (nome_categoria) 
values 
('Utilitário'),
('Material de construção'),
('Ferramentas');

insert into tegloja.produto (nome_produto, quantidade_estoque, valor_unitario, id_categoria)
values 
('Arruela', 1000, 2.42, 1),
('Porca', 1000, 0.34, 1),
('Bucha', 1000, 1.79, 1),
...
insert into tegloja.endereco (bairro, cep, localidade, logradouro, uf)
values
...
insert into tegloja.cliente (cep, cpf, email, nome_cliente, numero_endereco, id_endereco)
values
